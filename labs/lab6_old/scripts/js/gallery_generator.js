    ...
    xmlHttp.onreadystatechange = function() {
        if(xmlHttp.readyState == 4) {
            ...
            for (var i = 0; i < response.length; i++) {
                ...
                htmlCode += '<a href="assets/images/gallery_images' + response[i]+' " ' + ' data-fancybox data-caption="X3D model render" > ';
                htmlCode += '<img class="card-img-top img-thumbnail" src="assets/images/gallery_images' + response[i] + '" id="image_thumbnail"/>';
                htmlCode += '</a>';
                htmlCode += '</td>';
            }
